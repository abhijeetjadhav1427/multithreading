package thread.matrix.multiplication;
...
public class MatricesGenerator {
	private static final String OUTPUT_FILE = "./resources/matrices/matrices";
	...
	private static float[] createRow(Random random) {
		...
		for(int c=0; c<N; c++) {
			row[c] = random.nextFloat()*random.nextInt(100);
		}
